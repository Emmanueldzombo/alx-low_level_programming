 ...
 * @e_ident: Refers to a pointer of an array that contains the ELF magic numbers.
 * Description: If the files isnt an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Refers to a pointer to an array that contains the ELF magic numbers.
 ...
 * @e_ident: Refers to a pointer foro an array that contains the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: Refers to a pointer to an array that contains the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 * @e_ident: Refers to a pointer to an array that  contains the ELF version.
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
			  e_ident[EI_VERSION]);
 ...
 * @e_ident: Refers to a pointer of an array that contains the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: Refers to a pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type: This refers to the ELF type.
 * @e_ident: Refers to a pointer for an array that contains the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
