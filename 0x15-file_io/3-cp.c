 ...
 * @file: The name of the created file buffer for stored chars.
 *
 ...
 * @fd: Refers to the file descriptor to be closed.
 */
void close_file(int fd)
{
	int c;
...
/**
 * main - This copies the components of a file to another file.
 * @argc: Refers to the number of arguments given to the program.
